--Table client Nom : Type 2 et Prenom: Type 1
    update dsid_liv_ope.client set nom_client = 'Micael' where id_client = 1;
    update dsid_liv_ope.client set prenom_client = 'Henintsoa' where id_client = 1;

--Table Restaurant Type 3
    update dsid_liv_ope.Restaurant set code_restaurant='R1' where id_restaurant=1;

--Table moyen_paiement code_moyen_paiement: Type 0 
    update dsid_liv_ope.moyen_paiement set code_moyen_paiement='10' where id_moyen_paiement=1;
...
INSERT INTO dsid_liv_ope.livraison VALUES (dsid_liv_ope.seq_id_livraison.nextval, 1, 1, 1, TO_DATE('01-01-2023 14:40', 'DD-MM-YYYY HH24:MI'), TO_DATE('01-01-2023 14:55', 'DD-MM-YYYY HH24:MI'), 10);
